# Chay file nay 1 lan de them Tab AI vao thanh_toan_view.py
lines = open('views/thanh_toan_view.py', 'r', encoding='utf-8').readlines()

# Them Tab 4 sau dong 259
tab4_code = "        # Tab 4: AI Assistant\n        tab4 = self._build_tab_ai()\n        self.tabs.addTab(tab4, '🤖  AI Assistant')\n\n"
lines.insert(260, tab4_code)

# Them cac method AI vao cuoi file
ai_methods = '''
...
lines.append(ai_methods)
open('views/thanh_toan_view.py', 'w', encoding='utf-8').writelines(lines)
print("Them Tab AI thanh cong!")